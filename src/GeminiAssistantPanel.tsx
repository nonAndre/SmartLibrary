...
export default function GeminiAssistantPanel() {
  ...
  const intention ="Capisci dal contesto se si tratta di una richiesta di ricerca nell'archivio dei libri posseduti o di altro. Rispondi solo RICERCA se si tratta di una ricerca e solo con ALTRO se si tratta di altro. Richiesta: "
  const getTitlesPrompt = "Estrai dalla richiesta che segue i titoli/il titolo dei libri richiesti e rispondi dando SOLO l'elenco degli stessi nella forma titolo1,titolo2 e così via";
    ...
    <div className="fixed inset-0 z-50 flex justify-end items-end p-4 modal">
      <div className="relative bg-white w-[25%] h-[60%] p-4 rounded-2xl shadow-xl z-50 flex flex-col border border-gray-200">
        ...
        <div className="flex flex-row mb-4 items-center justify-between">
          <h1 className="text-xl font-semibold text-gray-800">Gemini Assistant</h1>
          <IoCloseSharp
